...
// source: mixer/adapter/vamp-kubist-istio-adapter/config/config.proto
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_b803f6e2a89d14e9, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/vamp-kubist-istio-adapter/config/config.proto", fileDescriptor_b803f6e2a89d14e9)
}
